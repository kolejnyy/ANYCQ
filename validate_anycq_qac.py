...
def validate_qac(config_file, model_dir, model_name, exp_name, _start=None, _end=None):
...
if __name__ == '__main__':
	...
	validate_qac(args.config_file, args.model_dir, args.model_name, exp_name, _start=args.start, _end=args.end)